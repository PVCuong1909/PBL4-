            ...
            <div class="grid">
                <nav class="navbar__header">
                    ...
                    <ul class="navbar__header-list">
                        ...
                        %>
                        <li class="navbar__header-item navbar__header-item--bold navbar__header-item--separate">
                        	<a href="ControllerServlet?action=register" class="navbar__header-item navbar__header-item--bold">
                        	<i class="navbar__header-icon fa-solid fa-circle-user"></i>
                        	<%= user %></a>
                        </li>
                        <li class="navbar__header-item navbar__header-item--bold"><a href="ControllerServlet?action=logout" class="navbar__header-item navbar__header-item--bold">Đăng xuất</a></li>
                    </ul>
                </nav>
                ...
                <div class="grid__row app-content">
                    ...
                    <div class="grid__column-10">
                        ...
                        <div class="home-content">
                            <div class="grid__row">
                            <% 
                            	ArrayList<allData> data = (ArrayList<allData>)request.getAttribute("data");
